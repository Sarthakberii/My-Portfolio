...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: FiMail,
      title: 'Email',
      value: 'sarthakberi45@gmail.com',
      href: 'mailto:sarthakberi45@gmail.com',
      clickable: false
    },
    {
      icon: FiPhone,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitURL = 'https://formsubmit.co/sarthakberi45@gmail.com';
      ...
      setIsSubmitting(false);
      alert('Failed to send message. Please try again or contact me directly at sarthakberi45@gmail.com');
    }
  };
