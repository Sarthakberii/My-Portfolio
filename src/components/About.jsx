...
const About = () => {
  ...
  const stats = [
    { icon: FiCode, label: 'Projects Built', value: '5+' },
    { icon: FiUsers, label: 'Current Year', value: '3rd' },
    { icon: FiAward, label: 'Certifications', value: '4' },
    { icon: FiHeart, label: 'Real-world Projects', value: '3+' }
  ];
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
                <p>
                  I'm a 3rd-year B.Tech Computer Science and Engineering student at Lovely Professional University,
                  passionate about building practical web solutions using the MERN stack (MongoDB, Express.js,
                  React.js, Node.js).
                </p>
                
                <p>
                  I have built real-world projects such as a tourism and hotel booking platform for Varanasi, an
                  event reminder system with automated email alerts, and a production-ready restaurant website.
                  These projects have strengthened my skills in full-stack development, authentication, and
                  performance optimization.
                </p>
                
                <p>
                  With a CGPA of 7.01 and multiple certifications in Java, data structures and algorithms, computer
                  communication, and generative AI, I am continuously improving and actively seeking opportunities to
                  apply my skills in professional environments.
                </p>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { emoji: '🎓', text: 'B.Tech CSE student at LPU, Phagwara (3rd Year)' },
                { emoji: '💻', text: 'Built tourism, event reminder, and restaurant web applications' },
                { emoji: '🏆', text: 'Certified in Java, DSA using Java, Computer Communication, and Generative AI tools' }
              ].map((fact, index) => (
                <motion.div
                  key={index}
