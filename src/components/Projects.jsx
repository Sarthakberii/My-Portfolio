...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: 'Hidden Kashi – Tourism & Hotel Booking Platform',
      category: 'Full Stack',
      description: 'A MERN-stack platform promoting Varanasi tourism with hotel booking, attraction guides, and restaurant listings.',
      longDescription: 'Developed a full-stack web application that showcases Varanasi tourism. The platform allows users to explore local attractions, browse restaurants, and securely book hotels. Implemented MongoDB for real-time booking management and Node.js/Express.js APIs, along with a secure payment gateway and dynamic search filters to boost user engagement and revenue.',
      image: '/Hidden Kashi.png',
      technologies: [
      ...
      github: 'https://github.com/Sarthakberii/Hidden-Kashi-Backend',
      live: '',
      features: [
        'Hotel booking with real-time availability',
        'Local attraction and restaurant listings',
    ...
    },
    {
      ...
      category: 'Full Stack',
      description: 'Web application to create, update, and track event reminders with email notifications.',
      longDescription: 'Built a MERN-stack event reminder system where users can manage events, receive automated email notifications, and stay organized. Designed RESTful APIs with Express.js, implemented JWT-based authentication for secure access, and improved productivity through automated alerts and reminders.',
      image: '/Event Reminder System.png',
      technologies: [
        { name: 'React', icon: FaReact, color: '#61DAFB' },
        { name: 'Node.js', icon: FaNodeJs, color: '#339933' },
        { name: 'MongoDB', icon: SiMongodb, color: '#47A248' },
      ...
      github: 'https://github.com/Sarthakberii/Event-Reminder',
      live: '',
      features: [
    ...
    },
    {
      ...
      category: 'Frontend',
      description: 'Dynamic restaurant website with interactive menus, table booking, and reviews.',
      longDescription: 'Created a responsive restaurant website using HTML, CSS, JavaScript, and Node.js. The site includes animated layouts, interactive menus, table booking, and review sections. Optimized loading times and deployed the application for production hosting.',
      image: '/Resturent.webp',
      technologies: [
        { name: 'React', icon: FaReact, color: '#61DAFB' },
        { name: 'Tailwind', icon: SiTailwindcss, color: '#06B6D4' }
      ],
      github: 'https://github.com/shikhar-verma11/Restaurent-Website',
      live: '',
      features: [
        'Interactive restaurant menu',
        'Table booking and review sections',
        'Animated layouts',
